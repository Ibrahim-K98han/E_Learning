<?php
    ...
    if(isset($_REQUEST['requpdate'])){
        ...
        || ($_REQUEST['course_id'] == "") || ($_REQUEST['course_name'] == "")){
            ...
            $sql = "UPDATE lesson SET lesson_id = '$lesson_id', lesson_name = '$lesson_name', 
            lesson_desc = '$lesson_desc', course_id='$course_id', course_name='$course_name',
            lesson_link='$link' WHERE lesson_id = '$lesson_id'";
